...
class Category extends DataClass implements Insertable<Category> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, color, icon, createdAt, isDeleted, deletedAt);
  @override
...
class $ReviewImagesTable extends ReviewImages
    with TableInfo<$ReviewImagesTable, ReviewImage> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ReviewImagesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  @override
  List<GeneratedColumn> get $columns => [id, imagePath, reviewId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'review_images';
  @override
  VerificationContext validateIntegrity(
    Insertable<ReviewImage> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ReviewImage map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ReviewImage(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
  ...
  @override
  $ReviewImagesTable createAlias(String alias) {
    return $ReviewImagesTable(attachedDatabase, alias);
  }
}

class ReviewImage extends DataClass implements Insertable<ReviewImage> {
  final int id;
  final String imagePath;
  final int reviewId;
  const ReviewImage({
  ...
  ReviewImagesCompanion toCompanion(bool nullToAbsent) {
    return ReviewImagesCompanion(
      id: Value(id),
  ...
  ReviewImage copyWith({int? id, String? imagePath, int? reviewId}) =>
      ReviewImage(
        id: id ?? this.id,
        imagePath: imagePath ?? this.imagePath,
        reviewId: reviewId ?? this.reviewId,
      );
  ReviewImage copyWithCompanion(ReviewImagesCompanion data) {
    return ReviewImage(
      id: data.id.present ? data.id.value : this.id,
      imagePath: data.imagePath.present ? data.imagePath.value : this.imagePath,
  ...
  @override
  String toString() {
    return (StringBuffer('ReviewImage(')
          ..write('id: $id, ')
          ..write('imagePath: $imagePath, ')
  ...
  @override
  int get hashCode => Object.hash(id, imagePath, reviewId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ReviewImage &&
          other.id == this.id &&
          other.imagePath == this.imagePath &&
          other.reviewId == this.reviewId);
}

class ReviewImagesCompanion extends UpdateCompanion<ReviewImage> {
  final Value<int> id;
  final Value<String> imagePath;
  final Value<int> reviewId;
  const ReviewImagesCompanion({
    this.id = const Value.absent(),
    this.imagePath = const Value.absent(),
    this.reviewId = const Value.absent(),
  });
  ReviewImagesCompanion.insert({
    this.id = const Value.absent(),
    required String imagePath,
    required int reviewId,
  }) : imagePath = Value(imagePath),
       reviewId = Value(reviewId);
  static Insertable<ReviewImage> custom({
    Expression<int>? id,
    Expression<String>? imagePath,
  ...
  ReviewImagesCompanion copyWith({
    Value<int>? id,
    Value<String>? imagePath,
    Value<int>? reviewId,
  }) {
  ...
  @override
  String toString() {
    return (StringBuffer('ReviewImagesCompanion(')
          ..write('id: $id, ')
          ..write('imagePath: $imagePath, ')
          ..write('reviewId: $reviewId')
          ..write(')'))
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final Index itemsIndex = Index(
    'items_index',
    'CREATE INDEX items_index ON items (category_id, folder_id, is_deleted)',
  );
  late final Index reviewsIndex = Index(
    'reviews_index',
    'CREATE INDEX reviews_index ON reviews (item_id, is_deleted)',
  );
  late final Index reviewImagesIndex = Index(
    'review_images_index',
    'CREATE INDEX review_images_index ON review_images (review_id)',
  );
  late final CategoriesDao categoriesDao = CategoriesDao(this as AppDatabase);
  late final ReviewImagesDao reviewImagesDao = ReviewImagesDao(
    this as AppDatabase,
  );
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules([
    ...
    WritePropagation(
      ...
      result: [TableUpdate('review_images', kind: UpdateKind.update)],
    ),
  ]);
}
    ...
    : super(
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({categoryId = false, folderId = false, reviewsRefs = false}) {
                return PrefetchHooks(
                  db: db,
...
typedef $$ItemsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (Item, $$ItemsTableReferences),
      Item,
      PrefetchHooks Function({bool categoryId, bool folderId, bool reviewsRefs})
    >;
...
final class $$ReviewsTableReferences
  ...
  static MultiTypedResultKey<$ReviewImagesTable, List<ReviewImage>>
  _reviewImagesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.reviewImages,
    aliasName: $_aliasNameGenerator(db.reviews.id, db.reviewImages.reviewId),
  );

  $$ReviewImagesTableProcessedTableManager get reviewImagesRefs {
    final manager = $$ReviewImagesTableTableManager(
      $_db,
      $_db.reviewImages,
    ).filter((f) => f.reviewId.id.sqlEquals($_itemColumn<int>('id')!));

    final cache = $_typedResult.readTableOrNull(_reviewImagesRefsTable($_db));
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  }
...
class $$ReviewsTableFilterComposer
  ...
  Expression<bool> reviewImagesRefs(
    Expression<bool> Function($$ReviewImagesTableFilterComposer f) f,
  ) {
    final $$ReviewImagesTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.reviewImages,
      ...
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$ReviewImagesTableFilterComposer(
            $db: $db,
            $table: $db.reviewImages,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
...
class $$ReviewsTableAnnotationComposer
  ...
  Expression<T> reviewImagesRefs<T extends Object>(
    Expression<T> Function($$ReviewImagesTableAnnotationComposer a) f,
  ) {
    final $$ReviewImagesTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.reviewImages,
      getReferencedColumn: (t) => t.reviewId,
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$ReviewImagesTableAnnotationComposer(
            $db: $db,
            $table: $db.reviewImages,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
...
class $$ReviewsTableTableManager
    extends
        RootTableManager<
          ...
          Review,
          PrefetchHooks Function({bool itemId, bool reviewImagesRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({itemId = false, reviewImagesRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [if (reviewImagesRefs) db.reviewImages],
              addJoins:
                  <
                    T extends TableManagerState<
                      dynamic,
                ...
                return [
                  if (reviewImagesRefs)
                    ...
                    >(
                      currentTable: table,
                      referencedTable: $$ReviewsTableReferences
                          ._reviewImagesRefsTable(db),
                      managerFromTypedResult: (p0) => $$ReviewsTableReferences(
                        db,
                        table,
                        p0,
                      ).reviewImagesRefs,
...
typedef $$ReviewsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool itemId, bool reviewImagesRefs})
    >;
typedef $$ReviewImagesTableCreateCompanionBuilder =
    ReviewImagesCompanion Function({
      Value<int> id,
      required String imagePath,
      required int reviewId,
    });
typedef $$ReviewImagesTableUpdateCompanionBuilder =
    ReviewImagesCompanion Function({
      Value<int> id,
      Value<String> imagePath,
      Value<int> reviewId,
...
final class $$ReviewImagesTableReferences
    extends BaseReferences<_$AppDatabase, $ReviewImagesTable, ReviewImage> {
  $$ReviewImagesTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $ReviewsTable _reviewIdTable(_$AppDatabase db) =>
      db.reviews.createAlias(
        $_aliasNameGenerator(db.reviewImages.reviewId, db.reviews.id),
      );
...
class $$ReviewImagesTableFilterComposer
    extends Composer<_$AppDatabase, $ReviewImagesTable> {
  $$ReviewImagesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$ReviewImagesTableOrderingComposer
    extends Composer<_$AppDatabase, $ReviewImagesTable> {
  $$ReviewImagesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ReviewImagesTableAnnotationComposer
    extends Composer<_$AppDatabase, $ReviewImagesTable> {
  $$ReviewImagesTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$ReviewImagesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $ReviewImagesTable,
          ...
          $$ReviewImagesTableOrderingComposer,
          $$ReviewImagesTableAnnotationComposer,
          $$ReviewImagesTableCreateCompanionBuilder,
          $$ReviewImagesTableUpdateCompanionBuilder,
          (ReviewImage, $$ReviewImagesTableReferences),
          ReviewImage,
          PrefetchHooks Function({bool reviewId})
        > {
  $$ReviewImagesTableTableManager(_$AppDatabase db, $ReviewImagesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$ReviewImagesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$ReviewImagesTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$ReviewImagesTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<String> imagePath = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$ReviewImagesTableReferences(db, table, e),
                ),
              )
              .toList(),
                    ...
                    if (reviewId) {
                      state =
                          state.withJoin(
                                ...
                                referencedTable: $$ReviewImagesTableReferences
                                    ._reviewIdTable(db),
                                referencedColumn: $$ReviewImagesTableReferences
                                    ._reviewIdTable(db)
                                    .id,
                              )
                              as T;
...
typedef $$ReviewImagesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $ReviewImagesTable,
      ReviewImage,
...
class $AppDatabaseManager {
  ...
  $$ReviewImagesTableTableManager get reviewImages =>
      $$ReviewImagesTableTableManager(_db, _db.reviewImages);
}
